...
LIB_DIRS=
C_DEBUG_FLAGS=-g
C_OPT_FLAGS=-ffast-math -fomit-frame-pointer
C_WARN_FLAGS=-W -Wall -Werror
C_C_LANG_FLAGS=
C_CXX_LANG_FLAGS=
C_P_LANG_FLAGS=
C_F_LANG_FLAGS=
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=a_ai.o d_drawer.o g_game.o i_main.o main.o s_script.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
MAIN_TARGET=ai.exe
PROJECT_ITEMS=a_ai.c d_drawer.c g_game.c i_main.c main.c s_script.c
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
	$(RHIDE_COMPILE_C)
