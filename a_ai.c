...
void A_BotThink( void )
{
 ...
 if(failed || failedspec)
 {
  if(defaults.debug)
  {
   A_AIDebug( "AI Loop - Failed" );
   A_IntAIDebug( failed );
   A_AIDebug( "AI Loop - FailedSpec" );
   A_IntAIDebug( failedspec );
  }
...
void A_AiLoop( void )
{
 ...
 do
 {
  ...
  if(defaults.debug)
  {
   A_AIDebug( player.state.action );
   A_AIDebug( "Goal" );
   A_IntAIDebug( player.goal );
   A_AIDebug( "Playerloc x,y" );
   A_IntAIDebug( player.loc.x );
   A_IntAIDebug( player.loc.y );
   A_AIDebug( "Nextloc x,y" );
   A_IntAIDebug( nextloc.x );
   A_IntAIDebug( nextloc.y );
  }
